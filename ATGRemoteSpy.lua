...
local Highlight = (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://raw.githubusercontent.com/ATGFAIL/ATGRemoteSpy/main/Highlight.lua"))()
...
if configs.supersecretdevtoggle then
    ...
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ATGFAIL/ATGRemoteSpy/blob/main/ATGSpy.lua"))()
    end)
